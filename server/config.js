...
export const config = {
  ...
  tvAutoTranscribeDailyLimit: Number(process.env.TV_AUTO_TRANSCRIBE_DAILY_LIMIT || 20),
  tvAutoTranscribeBatchSize: Number(process.env.TV_AUTO_TRANSCRIBE_BATCH_SIZE || 1),
